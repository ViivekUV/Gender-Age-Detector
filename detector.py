...
# Add a positional argument- to read image from cli
...
def highlightFace(net, frame, conf_threshold=0.7):
    ...
    net.setInput(blob)
    detections = net.forward() #returns the blobs that satisfy the computation 
    faceBoxes = []
...
# Protocol Buffer files for serializing structured data
...
# Caffe Model for Gender
genderProto = "gender_deploy.prototxt"
genderModel = "gender_net.caffemodel"

# These are our mean subtraction values, in a 3-tuple format of the RGB
